...
public open class Skin : Resource() {
  ...
  public fun setBindCount(bindCount: Int) {
  ...
  public fun addBind(bone: Int, pose: Transform3D) {
  ...
  public fun addNamedBind(name: String, pose: Transform3D) {
  ...
  public fun setBindPose(bindIndex: Int, pose: Transform3D) {
  ...
  public fun setBindName(bindIndex: Int, name: StringName) {
  ...
  public fun setBindBone(bindIndex: Int, bone: Int) {
