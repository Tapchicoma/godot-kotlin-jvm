...
import godot.TextServer.FontStyle
import godot.TextServer.GraphemeFlag
import godot.TextServer.JustificationFlag
import godot.TextServer.LineBreakFlag
import godot.TextServer.TextOverrunFlag
...
public open class TextServer internal constructor() : RefCounted() {
  ...
  public fun fontSetData(fontRid: RID, `data`: PackedByteArray) {
  ...
  public fun fontSetFaceIndex(fontRid: RID, faceIndex: Long) {
  ...
  public fun fontSetStyle(fontRid: RID, style: FontStyle) {
  ...
  public fun fontGetStyle(fontRid: RID): FontStyle {
    ...
    return godot.TextServer.FontStyleValue(TransferContext.readReturnValue(LONG) as Long)
  }

  public fun fontSetName(fontRid: RID, name: String) {
  ...
  public fun fontSetStyleName(fontRid: RID, name: String) {
    TransferContext.writeArguments(_RID to fontRid, STRING to name)
  ...
  public fun fontSetWeight(fontRid: RID, weight: Long) {
  ...
  public fun fontSetStretch(fontRid: RID, weight: Long) {
    TransferContext.writeArguments(_RID to fontRid, LONG to weight)
  ...
  public fun fontSetAntialiasing(fontRid: RID, antialiasing: FontAntialiasing) {
  ...
  public fun fontSetGenerateMipmaps(fontRid: RID, generateMipmaps: Boolean) {
  ...
  public fun fontSetMultichannelSignedDistanceField(fontRid: RID, msdf: Boolean) {
  ...
  public fun fontSetMsdfPixelRange(fontRid: RID, msdfPixelRange: Long) {
  ...
  public fun fontSetMsdfSize(fontRid: RID, msdfSize: Long) {
  ...
  public fun fontSetFixedSize(fontRid: RID, fixedSize: Long) {
  ...
  public fun fontSetAllowSystemFallback(fontRid: RID, allowSystemFallback: Boolean) {
  ...
  public fun fontSetForceAutohinter(fontRid: RID, forceAutohinter: Boolean) {
  ...
  public fun fontSetHinting(fontRid: RID, hinting: Hinting) {
  ...
  public fun fontSetEmbolden(fontRid: RID, strength: Double) {
  ...
  public fun fontSetTransform(fontRid: RID, transform: Transform2D) {
  ...
  public fun fontSetOversampling(fontRid: RID, oversampling: Double) {
  ...
  public fun fontClearSizeCache(fontRid: RID) {
    TransferContext.writeArguments(_RID to fontRid)
    TransferContext.callMethod(rawPtr, MethodBindings.fontClearSizeCachePtr, NIL)
  }

  public fun fontRemoveSizeCache(fontRid: RID, size: Vector2i) {
  ...
  public fun fontClearTextures(fontRid: RID, size: Vector2i) {
    TransferContext.writeArguments(_RID to fontRid, VECTOR2I to size)
  ...
  public fun fontClearGlyphs(fontRid: RID, size: Vector2i) {
    TransferContext.writeArguments(_RID to fontRid, VECTOR2I to size)
  ...
  public fun fontClearKerningMap(fontRid: RID, size: Long) {
    TransferContext.writeArguments(_RID to fontRid, LONG to size)
  ...
  public fun fontRemoveLanguageSupportOverride(fontRid: RID, language: String) {
    TransferContext.writeArguments(_RID to fontRid, STRING to language)
  ...
  public fun fontRemoveScriptSupportOverride(fontRid: RID, script: String) {
    TransferContext.writeArguments(_RID to fontRid, STRING to script)
  ...
  public fun fontSetGlobalOversampling(oversampling: Double) {
  ...
  public fun shapedTextClear(rid: RID) {
    TransferContext.writeArguments(_RID to rid)
  ...
  public fun shapedTextSetBidiOverride(shaped: RID, `override`: VariantArray<Any?>) {
  ...
  public fun shapedTextSetCustomPunctuation(shaped: RID, punct: String) {
  ...
  public fun shapedTextSetOrientation(shaped: RID, orientation: Orientation =
      TextServer.Orientation.ORIENTATION_HORIZONTAL) {
  ...
  public fun shapedTextSetPreserveInvalid(shaped: RID, enabled: Boolean) {
  ...
  public fun shapedTextSetPreserveControl(shaped: RID, enabled: Boolean) {
    TransferContext.writeArguments(_RID to shaped, BOOL to enabled)
  ...
  public enum class FontAntialiasing(
    ...
    public companion object {
      public fun from(`value`: Long): FontAntialiasing = entries.single {
          it.id == `value`
      }
    }
  }
  ...
  public enum class FontLCDSubpixelLayout(
    ...
    public companion object {
      public fun from(`value`: Long): FontLCDSubpixelLayout = entries.single {
          it.id == `value`
      }
    }
  }
  ...
  public enum class Direction(
    ...
    public companion object {
      public fun from(`value`: Long): Direction = entries.single {
          it.id == `value`
      }
    }
  }
  ...
  public sealed interface JustificationFlag {
    ...
    public infix fun or(other: godot.TextServer.JustificationFlag):
        godot.TextServer.JustificationFlag = JustificationFlagValue(flag.or(other.flag))

    public infix fun or(other: Long): godot.TextServer.JustificationFlag =
        JustificationFlagValue(flag.or(other))

    public infix fun xor(other: godot.TextServer.JustificationFlag):
        godot.TextServer.JustificationFlag = JustificationFlagValue(flag.xor(other.flag))

    public infix fun xor(other: Long): godot.TextServer.JustificationFlag =
        JustificationFlagValue(flag.xor(other))

    public infix fun and(other: godot.TextServer.JustificationFlag):
        godot.TextServer.JustificationFlag = JustificationFlagValue(flag.and(other.flag))

    public infix fun and(other: Long): godot.TextServer.JustificationFlag =
        JustificationFlagValue(flag.and(other))

    public operator fun plus(other: godot.TextServer.JustificationFlag):
        godot.TextServer.JustificationFlag = JustificationFlagValue(flag.plus(other.flag))

    public operator fun plus(other: Long): godot.TextServer.JustificationFlag =
        JustificationFlagValue(flag.plus(other))

    public operator fun minus(other: godot.TextServer.JustificationFlag):
        godot.TextServer.JustificationFlag = JustificationFlagValue(flag.minus(other.flag))

    public operator fun minus(other: Long): godot.TextServer.JustificationFlag =
        JustificationFlagValue(flag.minus(other))

    public operator fun times(other: godot.TextServer.JustificationFlag):
        godot.TextServer.JustificationFlag = JustificationFlagValue(flag.times(other.flag))

    public operator fun times(other: Long): godot.TextServer.JustificationFlag =
        JustificationFlagValue(flag.times(other))

    public operator fun div(other: godot.TextServer.JustificationFlag):
        godot.TextServer.JustificationFlag = JustificationFlagValue(flag.div(other.flag))

    public operator fun div(other: Long): godot.TextServer.JustificationFlag =
        JustificationFlagValue(flag.div(other))

    public operator fun rem(other: godot.TextServer.JustificationFlag):
        godot.TextServer.JustificationFlag = JustificationFlagValue(flag.rem(other.flag))

    public operator fun rem(other: Long): godot.TextServer.JustificationFlag =
        JustificationFlagValue(flag.rem(other))

    public fun unaryPlus(): godot.TextServer.JustificationFlag =
        JustificationFlagValue(flag.unaryPlus())

    public fun unaryMinus(): godot.TextServer.JustificationFlag =
        JustificationFlagValue(flag.unaryMinus())

    public fun inv(): godot.TextServer.JustificationFlag = JustificationFlagValue(flag.inv())

    public infix fun shl(bits: Int): godot.TextServer.JustificationFlag =
        JustificationFlagValue(flag shl bits)

    public infix fun shr(bits: Int): godot.TextServer.JustificationFlag =
        JustificationFlagValue(flag shr bits)

    public infix fun ushr(bits: Int): godot.TextServer.JustificationFlag =
        JustificationFlagValue(flag ushr bits)

    public companion object {
      public val JUSTIFICATION_NONE: godot.TextServer.JustificationFlag =
          godot.TextServer.JustificationFlagValue(0)

      public val JUSTIFICATION_KASHIDA: godot.TextServer.JustificationFlag =
          godot.TextServer.JustificationFlagValue(1)

      public val JUSTIFICATION_WORD_BOUND: godot.TextServer.JustificationFlag =
          godot.TextServer.JustificationFlagValue(2)

      public val JUSTIFICATION_TRIM_EDGE_SPACES: godot.TextServer.JustificationFlag =
          godot.TextServer.JustificationFlagValue(4)

      public val JUSTIFICATION_AFTER_LAST_TAB: godot.TextServer.JustificationFlag =
          godot.TextServer.JustificationFlagValue(8)

      public val JUSTIFICATION_CONSTRAIN_ELLIPSIS: godot.TextServer.JustificationFlag =
          godot.TextServer.JustificationFlagValue(16)

      public val JUSTIFICATION_SKIP_LAST_LINE: godot.TextServer.JustificationFlag =
          godot.TextServer.JustificationFlagValue(32)

      public val JUSTIFICATION_SKIP_LAST_LINE_WITH_VISIBLE_CHARS: godot.TextServer.JustificationFlag
          = godot.TextServer.JustificationFlagValue(64)

      public val JUSTIFICATION_DO_NOT_SKIP_SINGLE_LINE: godot.TextServer.JustificationFlag =
          godot.TextServer.JustificationFlagValue(128)
    }
  }
  ...
  ) : godot.TextServer.JustificationFlag
  ...
  public enum class AutowrapMode(
    ...
    public companion object {
      public fun from(`value`: Long): AutowrapMode = entries.single {
          it.id == `value`
      }
    }
  }
  ...
  public sealed interface LineBreakFlag {
    ...
    public infix fun or(other: godot.TextServer.LineBreakFlag): godot.TextServer.LineBreakFlag =
        LineBreakFlagValue(flag.or(other.flag))

    public infix fun or(other: Long): godot.TextServer.LineBreakFlag =
        LineBreakFlagValue(flag.or(other))

    public infix fun xor(other: godot.TextServer.LineBreakFlag): godot.TextServer.LineBreakFlag =
        LineBreakFlagValue(flag.xor(other.flag))

    public infix fun xor(other: Long): godot.TextServer.LineBreakFlag =
        LineBreakFlagValue(flag.xor(other))

    public infix fun and(other: godot.TextServer.LineBreakFlag): godot.TextServer.LineBreakFlag =
        LineBreakFlagValue(flag.and(other.flag))

    public infix fun and(other: Long): godot.TextServer.LineBreakFlag =
        LineBreakFlagValue(flag.and(other))

    public operator fun plus(other: godot.TextServer.LineBreakFlag): godot.TextServer.LineBreakFlag
        = LineBreakFlagValue(flag.plus(other.flag))

    public operator fun plus(other: Long): godot.TextServer.LineBreakFlag =
        LineBreakFlagValue(flag.plus(other))

    public operator fun minus(other: godot.TextServer.LineBreakFlag): godot.TextServer.LineBreakFlag
        = LineBreakFlagValue(flag.minus(other.flag))

    public operator fun minus(other: Long): godot.TextServer.LineBreakFlag =
        LineBreakFlagValue(flag.minus(other))

    public operator fun times(other: godot.TextServer.LineBreakFlag): godot.TextServer.LineBreakFlag
        = LineBreakFlagValue(flag.times(other.flag))

    public operator fun times(other: Long): godot.TextServer.LineBreakFlag =
        LineBreakFlagValue(flag.times(other))

    public operator fun div(other: godot.TextServer.LineBreakFlag): godot.TextServer.LineBreakFlag =
        LineBreakFlagValue(flag.div(other.flag))

    public operator fun div(other: Long): godot.TextServer.LineBreakFlag =
        LineBreakFlagValue(flag.div(other))

    public operator fun rem(other: godot.TextServer.LineBreakFlag): godot.TextServer.LineBreakFlag =
        LineBreakFlagValue(flag.rem(other.flag))

    public operator fun rem(other: Long): godot.TextServer.LineBreakFlag =
        LineBreakFlagValue(flag.rem(other))

    public fun unaryPlus(): godot.TextServer.LineBreakFlag = LineBreakFlagValue(flag.unaryPlus())

    public fun unaryMinus(): godot.TextServer.LineBreakFlag = LineBreakFlagValue(flag.unaryMinus())

    public fun inv(): godot.TextServer.LineBreakFlag = LineBreakFlagValue(flag.inv())

    public infix fun shl(bits: Int): godot.TextServer.LineBreakFlag =
        LineBreakFlagValue(flag shl bits)

    public infix fun shr(bits: Int): godot.TextServer.LineBreakFlag =
        LineBreakFlagValue(flag shr bits)

    public infix fun ushr(bits: Int): godot.TextServer.LineBreakFlag =
        LineBreakFlagValue(flag ushr bits)

    public companion object {
      public val BREAK_NONE: godot.TextServer.LineBreakFlag = godot.TextServer.LineBreakFlagValue(0)

      public val BREAK_MANDATORY: godot.TextServer.LineBreakFlag =
          godot.TextServer.LineBreakFlagValue(1)

      public val BREAK_WORD_BOUND: godot.TextServer.LineBreakFlag =
          godot.TextServer.LineBreakFlagValue(2)

      public val BREAK_GRAPHEME_BOUND: godot.TextServer.LineBreakFlag =
          godot.TextServer.LineBreakFlagValue(4)

      public val BREAK_ADAPTIVE: godot.TextServer.LineBreakFlag =
          godot.TextServer.LineBreakFlagValue(8)

      public val BREAK_TRIM_EDGE_SPACES: godot.TextServer.LineBreakFlag =
          godot.TextServer.LineBreakFlagValue(16)
    }
  }
  ...
  internal value class LineBreakFlagValue internal constructor(
    override val flag: Long,
  ) : godot.TextServer.LineBreakFlag
  ...
  public enum class VisibleCharactersBehavior(
    ...
    public companion object {
      public fun from(`value`: Long): VisibleCharactersBehavior = entries.single {
          it.id == `value`
      }
    }
  }
  ...
  public enum class OverrunBehavior(
    ...
    public companion object {
      public fun from(`value`: Long): OverrunBehavior = entries.single {
          it.id == `value`
      }
    }
  }
  ...
  public sealed interface TextOverrunFlag {
    ...
    public infix fun or(other: godot.TextServer.TextOverrunFlag): godot.TextServer.TextOverrunFlag =
        TextOverrunFlagValue(flag.or(other.flag))

    public infix fun or(other: Long): godot.TextServer.TextOverrunFlag =
        TextOverrunFlagValue(flag.or(other))

    public infix fun xor(other: godot.TextServer.TextOverrunFlag): godot.TextServer.TextOverrunFlag
        = TextOverrunFlagValue(flag.xor(other.flag))

    public infix fun xor(other: Long): godot.TextServer.TextOverrunFlag =
        TextOverrunFlagValue(flag.xor(other))

    public infix fun and(other: godot.TextServer.TextOverrunFlag): godot.TextServer.TextOverrunFlag
        = TextOverrunFlagValue(flag.and(other.flag))

    public infix fun and(other: Long): godot.TextServer.TextOverrunFlag =
        TextOverrunFlagValue(flag.and(other))

    public operator fun plus(other: godot.TextServer.TextOverrunFlag):
        godot.TextServer.TextOverrunFlag = TextOverrunFlagValue(flag.plus(other.flag))

    public operator fun plus(other: Long): godot.TextServer.TextOverrunFlag =
        TextOverrunFlagValue(flag.plus(other))

    public operator fun minus(other: godot.TextServer.TextOverrunFlag):
        godot.TextServer.TextOverrunFlag = TextOverrunFlagValue(flag.minus(other.flag))

    public operator fun minus(other: Long): godot.TextServer.TextOverrunFlag =
        TextOverrunFlagValue(flag.minus(other))

    public operator fun times(other: godot.TextServer.TextOverrunFlag):
        godot.TextServer.TextOverrunFlag = TextOverrunFlagValue(flag.times(other.flag))

    public operator fun times(other: Long): godot.TextServer.TextOverrunFlag =
        TextOverrunFlagValue(flag.times(other))

    public operator fun div(other: godot.TextServer.TextOverrunFlag):
        godot.TextServer.TextOverrunFlag = TextOverrunFlagValue(flag.div(other.flag))

    public operator fun div(other: Long): godot.TextServer.TextOverrunFlag =
        TextOverrunFlagValue(flag.div(other))

    public operator fun rem(other: godot.TextServer.TextOverrunFlag):
        godot.TextServer.TextOverrunFlag = TextOverrunFlagValue(flag.rem(other.flag))

    public operator fun rem(other: Long): godot.TextServer.TextOverrunFlag =
        TextOverrunFlagValue(flag.rem(other))

    public fun unaryPlus(): godot.TextServer.TextOverrunFlag =
        TextOverrunFlagValue(flag.unaryPlus())

    public fun unaryMinus(): godot.TextServer.TextOverrunFlag =
        TextOverrunFlagValue(flag.unaryMinus())

    public fun inv(): godot.TextServer.TextOverrunFlag = TextOverrunFlagValue(flag.inv())

    public infix fun shl(bits: Int): godot.TextServer.TextOverrunFlag =
        TextOverrunFlagValue(flag shl bits)

    public infix fun shr(bits: Int): godot.TextServer.TextOverrunFlag =
        TextOverrunFlagValue(flag shr bits)

    public infix fun ushr(bits: Int): godot.TextServer.TextOverrunFlag =
        TextOverrunFlagValue(flag ushr bits)

    public companion object {
      public val OVERRUN_NO_TRIM: godot.TextServer.TextOverrunFlag =
          godot.TextServer.TextOverrunFlagValue(0)

      public val OVERRUN_TRIM: godot.TextServer.TextOverrunFlag =
          godot.TextServer.TextOverrunFlagValue(1)

      public val OVERRUN_TRIM_WORD_ONLY: godot.TextServer.TextOverrunFlag =
          godot.TextServer.TextOverrunFlagValue(2)

      public val OVERRUN_ADD_ELLIPSIS: godot.TextServer.TextOverrunFlag =
          godot.TextServer.TextOverrunFlagValue(4)

      public val OVERRUN_ENFORCE_ELLIPSIS: godot.TextServer.TextOverrunFlag =
          godot.TextServer.TextOverrunFlagValue(8)

      public val OVERRUN_JUSTIFICATION_AWARE: godot.TextServer.TextOverrunFlag =
          godot.TextServer.TextOverrunFlagValue(16)
    }
  }
  ...
  internal value class TextOverrunFlagValue internal constructor(
    override val flag: Long,
  ) : godot.TextServer.TextOverrunFlag

  public sealed interface GraphemeFlag {
    public val flag: Long

    public infix fun or(other: godot.TextServer.GraphemeFlag): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag.or(other.flag))

    public infix fun or(other: Long): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag.or(other))

    public infix fun xor(other: godot.TextServer.GraphemeFlag): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag.xor(other.flag))

    public infix fun xor(other: Long): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag.xor(other))

    public infix fun and(other: godot.TextServer.GraphemeFlag): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag.and(other.flag))

    public infix fun and(other: Long): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag.and(other))

    public operator fun plus(other: godot.TextServer.GraphemeFlag): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag.plus(other.flag))

    public operator fun plus(other: Long): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag.plus(other))

    public operator fun minus(other: godot.TextServer.GraphemeFlag): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag.minus(other.flag))

    public operator fun minus(other: Long): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag.minus(other))

    public operator fun times(other: godot.TextServer.GraphemeFlag): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag.times(other.flag))

    public operator fun times(other: Long): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag.times(other))

    public operator fun div(other: godot.TextServer.GraphemeFlag): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag.div(other.flag))

    public operator fun div(other: Long): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag.div(other))

    public operator fun rem(other: godot.TextServer.GraphemeFlag): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag.rem(other.flag))

    public operator fun rem(other: Long): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag.rem(other))

    public fun unaryPlus(): godot.TextServer.GraphemeFlag = GraphemeFlagValue(flag.unaryPlus())

    public fun unaryMinus(): godot.TextServer.GraphemeFlag = GraphemeFlagValue(flag.unaryMinus())

    public fun inv(): godot.TextServer.GraphemeFlag = GraphemeFlagValue(flag.inv())

    public infix fun shl(bits: Int): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag shl bits)

    public infix fun shr(bits: Int): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag shr bits)

    public infix fun ushr(bits: Int): godot.TextServer.GraphemeFlag =
        GraphemeFlagValue(flag ushr bits)

    public companion object {
      public val GRAPHEME_IS_VALID: godot.TextServer.GraphemeFlag =
          godot.TextServer.GraphemeFlagValue(1)

      public val GRAPHEME_IS_RTL: godot.TextServer.GraphemeFlag =
          godot.TextServer.GraphemeFlagValue(2)

      public val GRAPHEME_IS_VIRTUAL: godot.TextServer.GraphemeFlag =
          godot.TextServer.GraphemeFlagValue(4)

      public val GRAPHEME_IS_SPACE: godot.TextServer.GraphemeFlag =
          godot.TextServer.GraphemeFlagValue(8)

      public val GRAPHEME_IS_BREAK_HARD: godot.TextServer.GraphemeFlag =
          godot.TextServer.GraphemeFlagValue(16)

      public val GRAPHEME_IS_BREAK_SOFT: godot.TextServer.GraphemeFlag =
          godot.TextServer.GraphemeFlagValue(32)

      public val GRAPHEME_IS_TAB: godot.TextServer.GraphemeFlag =
          godot.TextServer.GraphemeFlagValue(64)

      public val GRAPHEME_IS_ELONGATION: godot.TextServer.GraphemeFlag =
          godot.TextServer.GraphemeFlagValue(128)

      public val GRAPHEME_IS_PUNCTUATION: godot.TextServer.GraphemeFlag =
          godot.TextServer.GraphemeFlagValue(256)

      public val GRAPHEME_IS_UNDERSCORE: godot.TextServer.GraphemeFlag =
          godot.TextServer.GraphemeFlagValue(512)

      public val GRAPHEME_IS_CONNECTED: godot.TextServer.GraphemeFlag =
          godot.TextServer.GraphemeFlagValue(1_024)

      public val GRAPHEME_IS_SAFE_TO_INSERT_TATWEEL: godot.TextServer.GraphemeFlag =
          godot.TextServer.GraphemeFlagValue(2_048)

      public val GRAPHEME_IS_EMBEDDED_OBJECT: godot.TextServer.GraphemeFlag =
          godot.TextServer.GraphemeFlagValue(4_096)
    }
  }
  ...
  public enum class Hinting(
    ...
    public companion object {
      public fun from(`value`: Long): Hinting = entries.single {
          it.id == `value`
      }
    }
  }
  ...
  public enum class SubpixelPositioning(
    ...
    public companion object {
      public fun from(`value`: Long): SubpixelPositioning = entries.single {
          it.id == `value`
      }
    }
  }
  ...
  public enum class Feature(
    ...
    FEATURE_FONT_VARIABLE(1_024),
    FEATURE_CONTEXT_SENSITIVE_CASE_CONVERSION(2_048),
    FEATURE_USE_SUPPORT_DATA(4_096),
    FEATURE_UNICODE_IDENTIFIERS(8_192),
    FEATURE_UNICODE_SECURITY(16_384),
    ;
  ...
  public enum class ContourPointTag(
    ...
    public companion object {
      public fun from(`value`: Long): ContourPointTag = entries.single {
          it.id == `value`
      }
    }
  }
  ...
  public enum class SpacingType(
    ...
    public companion object {
      public fun from(`value`: Long): SpacingType = entries.single {
          it.id == `value`
      }
    }
  }
  ...
  public sealed interface FontStyle {
    ...
    public infix fun or(other: godot.TextServer.FontStyle): godot.TextServer.FontStyle =
        FontStyleValue(flag.or(other.flag))

    public infix fun or(other: Long): godot.TextServer.FontStyle = FontStyleValue(flag.or(other))

    public infix fun xor(other: godot.TextServer.FontStyle): godot.TextServer.FontStyle =
        FontStyleValue(flag.xor(other.flag))

    public infix fun xor(other: Long): godot.TextServer.FontStyle = FontStyleValue(flag.xor(other))

    public infix fun and(other: godot.TextServer.FontStyle): godot.TextServer.FontStyle =
        FontStyleValue(flag.and(other.flag))

    public infix fun and(other: Long): godot.TextServer.FontStyle = FontStyleValue(flag.and(other))

    public operator fun plus(other: godot.TextServer.FontStyle): godot.TextServer.FontStyle =
        FontStyleValue(flag.plus(other.flag))

    public operator fun plus(other: Long): godot.TextServer.FontStyle =
        FontStyleValue(flag.plus(other))

    public operator fun minus(other: godot.TextServer.FontStyle): godot.TextServer.FontStyle =
        FontStyleValue(flag.minus(other.flag))

    public operator fun minus(other: Long): godot.TextServer.FontStyle =
        FontStyleValue(flag.minus(other))

    public operator fun times(other: godot.TextServer.FontStyle): godot.TextServer.FontStyle =
        FontStyleValue(flag.times(other.flag))

    public operator fun times(other: Long): godot.TextServer.FontStyle =
        FontStyleValue(flag.times(other))

    public operator fun div(other: godot.TextServer.FontStyle): godot.TextServer.FontStyle =
        FontStyleValue(flag.div(other.flag))

    public operator fun div(other: Long): godot.TextServer.FontStyle =
        FontStyleValue(flag.div(other))

    public operator fun rem(other: godot.TextServer.FontStyle): godot.TextServer.FontStyle =
        FontStyleValue(flag.rem(other.flag))

    public operator fun rem(other: Long): godot.TextServer.FontStyle =
        FontStyleValue(flag.rem(other))

    public fun unaryPlus(): godot.TextServer.FontStyle = FontStyleValue(flag.unaryPlus())

    public fun unaryMinus(): godot.TextServer.FontStyle = FontStyleValue(flag.unaryMinus())

    public fun inv(): godot.TextServer.FontStyle = FontStyleValue(flag.inv())

    public infix fun shl(bits: Int): godot.TextServer.FontStyle = FontStyleValue(flag shl bits)

    public infix fun shr(bits: Int): godot.TextServer.FontStyle = FontStyleValue(flag shr bits)

    public infix fun ushr(bits: Int): godot.TextServer.FontStyle = FontStyleValue(flag ushr bits)

    public companion object {
      public val FONT_BOLD: godot.TextServer.FontStyle = godot.TextServer.FontStyleValue(1)

      public val FONT_ITALIC: godot.TextServer.FontStyle = godot.TextServer.FontStyleValue(2)

      public val FONT_FIXED_WIDTH: godot.TextServer.FontStyle = godot.TextServer.FontStyleValue(4)
    }
  }
  ...
  public enum class StructuredTextParser(
    ...
    public companion object {
      public fun from(`value`: Long): StructuredTextParser = entries.single {
          it.id == `value`
      }
    }
  }
...
public infix fun Long.or(other: JustificationFlag): Long = this.or(other.flag)

public infix fun Long.xor(other: JustificationFlag): Long = this.xor(other.flag)

public infix fun Long.and(other: JustificationFlag): Long = this.and(other.flag)

public operator fun Long.plus(other: JustificationFlag): Long = this.plus(other.flag)

public operator fun Long.minus(other: JustificationFlag): Long = this.minus(other.flag)

public operator fun Long.times(other: JustificationFlag): Long = this.times(other.flag)

public operator fun Long.div(other: JustificationFlag): Long = this.div(other.flag)

public operator fun Long.rem(other: JustificationFlag): Long = this.rem(other.flag)

public infix fun Long.or(other: LineBreakFlag): Long = this.or(other.flag)

public infix fun Long.xor(other: LineBreakFlag): Long = this.xor(other.flag)

public infix fun Long.and(other: LineBreakFlag): Long = this.and(other.flag)

public operator fun Long.plus(other: LineBreakFlag): Long = this.plus(other.flag)

public operator fun Long.minus(other: LineBreakFlag): Long = this.minus(other.flag)

public operator fun Long.times(other: LineBreakFlag): Long = this.times(other.flag)

public operator fun Long.div(other: LineBreakFlag): Long = this.div(other.flag)

public operator fun Long.rem(other: LineBreakFlag): Long = this.rem(other.flag)

public infix fun Long.or(other: TextOverrunFlag): Long = this.or(other.flag)

public infix fun Long.xor(other: TextOverrunFlag): Long = this.xor(other.flag)

public infix fun Long.and(other: TextOverrunFlag): Long = this.and(other.flag)

public operator fun Long.plus(other: TextOverrunFlag): Long = this.plus(other.flag)

public operator fun Long.minus(other: TextOverrunFlag): Long = this.minus(other.flag)

public operator fun Long.times(other: TextOverrunFlag): Long = this.times(other.flag)

public operator fun Long.div(other: TextOverrunFlag): Long = this.div(other.flag)

public operator fun Long.rem(other: TextOverrunFlag): Long = this.rem(other.flag)

public infix fun Long.or(other: GraphemeFlag): Long = this.or(other.flag)

public infix fun Long.xor(other: GraphemeFlag): Long = this.xor(other.flag)

public infix fun Long.and(other: GraphemeFlag): Long = this.and(other.flag)

public operator fun Long.plus(other: GraphemeFlag): Long = this.plus(other.flag)

public operator fun Long.minus(other: GraphemeFlag): Long = this.minus(other.flag)

public operator fun Long.times(other: GraphemeFlag): Long = this.times(other.flag)

public operator fun Long.div(other: GraphemeFlag): Long = this.div(other.flag)

public operator fun Long.rem(other: GraphemeFlag): Long = this.rem(other.flag)

public infix fun Long.or(other: FontStyle): Long = this.or(other.flag)

public infix fun Long.xor(other: FontStyle): Long = this.xor(other.flag)

public infix fun Long.and(other: FontStyle): Long = this.and(other.flag)

public operator fun Long.plus(other: FontStyle): Long = this.plus(other.flag)

public operator fun Long.minus(other: FontStyle): Long = this.minus(other.flag)

public operator fun Long.times(other: FontStyle): Long = this.times(other.flag)

public operator fun Long.div(other: FontStyle): Long = this.div(other.flag)

public operator fun Long.rem(other: FontStyle): Long = this.rem(other.flag)
